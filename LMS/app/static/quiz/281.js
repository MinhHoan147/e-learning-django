...
const sendData = () => {
    ...
    $.ajax({
        ...
        // });
            ...
            console.log('BBBBBBBBBBBBBBBBBBBBBBBB: ', response.results)
            scoreBox.innerHTML = `${response.passed ? 'Congratulation!' : 'Sorry you`re failed'} | Your score is ${response.score}`

            results.forEach(res => {
                console.log('CCCCCCCCCCCCCCCCCCCCCCCCCCCCCC: ', res)
                console.log('DDDDDDDDDDDDDDDDDDDDDDDDDDDDDD: ', res.Object==undefined)
