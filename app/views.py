...
def INSTRUCTOR_SEARCH_COURSE(request):
    ...
    print("AAAAAAAAAAAAAAAAAAAaaaaaaaaaaaaaaaaa: ", courses)
    try:
        status = request.GET['status']
        if status == "Confirmed":
            status = "PUBLISH"
...
def CHECKOUT(request, slug):
    ...
    print('HOSTHOSTHOSTHOSTHOSTHOSTHOST: ', host)
    # # paypal_dict = {}
    # if course.price == 0:
    #     course = UserCourse(
    #         user=request.user,
    ...
    print("AAAAAAAAAAAAAAAAAAAAAAAAAAA: ", paypal_dict['return_url'])
    print("BBBBBBBBBBBBBBBBBBBBBBBBBBB: ", paypal_dict['cancel_url'])
    print("CCCCCCCCCCCCCCCCCCCCCCCCCCC: ", paypal_dict['notify_url'])
    print("EEEEEEEEEEEEEEEEEEEEEEEEEEE: ", paypal_dict['business'])
...
def InstructorCreateCourse(request):
    ...
    if request.method == 'POST':
        ...
        createCourseForm = InstructorCreateCourseForm()
    return render(request, 'app/instructor/create_course_form.html', context=mydict)
...
def InstructorCreateQuiz(request):
    ...
    if request.method == 'POST':
        ...
        createQuizForm = InstructorCreateQuizzForm(request.user, request.POST)
    return render(request, 'app/instructor/create_quiz_form.html', context=mydict)
...
def InstructorCreateVideo(request):
    ...
    if request.method == 'POST':
        ...
        if createVideoForm.is_valid():
            ...
            newVideo.lesson = Lesson.objects.get(name=request.POST.get('lessson'))
        ...
        createVideoForm = InstructorCreateVideoForm(request.user, request.POST)
    return render(request, 'app/instructor/create_video_form.html', context=mydict)


def InstructorUpdateCourse(request, slug):
    course = Course.objects.get(slug=slug)
    updateCourseForm = InstructorCreateCourseForm()
    author = User.objects.get(username=request.user)
    message = None
    ...
    return render(request, 'app/instructor/update_course_forn.html', context=mydict)

def InstructorUpdateLesson(request, slug):
    course = Course.objects.get(slug=slug)
    updateCourseForm = InstructorCreateLessonForm()
    author = User.objects.get(username=request.user)
    message = None
    mydict = {'updateCourseForm': updateCourseForm,
              'author': author,
    ...
    if request.method == 'POST':
        updateCourseForm = InstructorCreateLessonForm(request.POST)
        if updateCourseForm.is_valid():
            course_updated = Course.objects.get(title=course.title)
            course_updated.featured_video = request.POST.get('featured_video')
            course_updated.title = request.POST.get('title')
        ...
        updateCourseForm = InstructorCreateCourseForm(request.user)
    return render(request, 'app/instructor/update_lesson_forn.html', context=mydict)

def InstructorUpdateQuiz(request, slug):
    course = Course.objects.get(slug=slug)
    updateCourseForm = InstructorCreateQuizzForm()
    author = User.objects.get(username=request.user)
    message = None
    mydict = {'updateCourseForm': updateCourseForm,
              'author': author,
    ...
    if request.method == 'POST':
        updateCourseForm = InstructorCreateQuizzForm(request.POST)
        if updateCourseForm.is_valid():
            course_updated = Course.objects.get(title=course.title)
            course_updated.featured_video = request.POST.get('featured_video')
            course_updated.title = request.POST.get('title')
        ...
        updateCourseForm = InstructorCreateQuizzForm(request.user)
    return render(request, 'app/instructor/update_quiz_forn.html', context=mydict)

def InstructorUpdateVideo(request, slug):
    video = Video.objects.get(slug=slug)
    updateVideoForm = InstructorCreateVideoForm()
    author = User.objects.get(username=request.user)
    message = None
    mydict = {'updateCourseForm': updateVideoForm,
              'author': author,
              'message': message,
    ...
    if request.method == 'POST':
        updateCourseForm = InstructorCreateVideoForm(request.POST)
        if updateCourseForm.is_valid():
            course_updated = Course.objects.get(title=course.title)
            course_updated.featured_video = request.POST.get('featured_video')
            course_updated.title = request.POST.get('title')
    ...
    return render(request, 'app/instructor/update_video_forn.html', context=mydict)
...
def VIDEO_LECTURE_DETAILS(request, slug):
    ...
    return render(request, 'app/instructor/update_video_form.html', context)
...
def LESSON_DETAILS(request, slug):
    ...
    return render(request, 'app/instructor/update_lesson_form.html', context)
...
def INSTRUCTOR_COURSE_DETAILS(request, slug):
    ...
    return render(request, 'app/instructor/update_course_forn.html', context)
...
def UPDATE_INSTRUCTOR_PROFILE(request):
    ...
    return render(request, 'app/instructor/instructor_profile.html')
