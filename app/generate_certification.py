...
def generate_certificates(name, courseName, date, id, instructor):
    ...
    print("CCCCCCCCCCCCCCCCCCCC: ", cur_path)
    path = cur_path + "\Media\certificate"
    # prints all files
    ...
    certificate_template_image = cv2.imread(path + "\certificate-templates.jpeg")
    print("AAAAAAAAAAAAAAAAAAAAAAAAA: ", certificate_template_image)
